#!/usr/bin/env python 
"""
Modified by Luke Lowrey 2016, fourfiftythree design
...
styles = {
        ...
        "biarc_style" : {
                ...
                'line':        simplestyle.formatStyle({ 'stroke': '#0f8', 'fill': 'none', "marker-end":"url(#DrawCurveMarker)", 'stroke-width':'1' }),
...
################################################################################
    def generate_gcode(self, curve, layer, depth):
        ...
        g = ""
        layer_name = layer.get(inkex.addNS('label','inkscape'));
        g += "\n\n##### Layer: '%s' #####\n" % layer_name

        # ============== TODO - load these from the layer name =================
...
################################################################################
    def laser(self) :
        ...
        if self.selected_paths == {} :
            ...
            print_("Paths are selected. Only the selected paths are being rendered");
...
################################################################################
    def effect(self) :
        ...
        self.tools = {
            ...
            "gcode after path": ("" + self.options.laser_off_command + " S0" + "\n" + "G1 F" + self.options.travel_speed),
        }
